...
Inherit [../../AGENTS.md](../../AGENTS.md#validation): `mechanics/part-local`; see [VALIDATION.md](../../../VALIDATION.md) and `config/validation_lanes.json`. Local `mechanics/recurrence/legacy/AGENTS.md`: lineage/raw-source boundaries.
## Closeout

Local delta `mechanics/recurrence/legacy/AGENTS.md`: preserve lineage and state any active-source handoff left unchanged.
