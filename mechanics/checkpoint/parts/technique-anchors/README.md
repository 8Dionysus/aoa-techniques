...
| [AOA-T-0026 session-capture-as-repo-artifact](../../../../techniques/history/history-artifacts/session-capture-as-repo-artifact/TECHNIQUE.md) | Preserves session history as project-scoped artifacts that can later support review or handoff. | Does not create memory recall semantics, policy authority, or checkpoint implementation truth. |
| [AOA-T-0045 witness-trace-as-reviewable-artifact](../../../../techniques/history/history-artifacts/witness-trace-as-reviewable-artifact/TECHNIQUE.md) | Preserves a bounded run trace before writeback, compost promotion, or canon lift. | Does not own runtime witness generation, memory writeback, proof, or promotion policy. |
