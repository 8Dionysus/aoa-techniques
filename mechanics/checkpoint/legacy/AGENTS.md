...
This card applies to `mechanics/checkpoint/legacy/` and every descendant unless a nearer
...
Inherit [../../AGENTS.md](../../AGENTS.md#validation): `mechanics/part-local`; see [VALIDATION.md](../../../VALIDATION.md) and `config/validation_lanes.json`. Local `mechanics/checkpoint/legacy/AGENTS.md`: lineage/raw-source boundaries.
## Closeout

Local delta `mechanics/checkpoint/legacy/AGENTS.md`: preserve lineage and state any active-source handoff left unchanged.
