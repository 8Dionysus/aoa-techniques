...
boundary-bridge law, owner acceptance, or validator behavior by itself.

## Current Contour

Boundary-bridge is the local route for owner-boundary, derived-projection, and
proof-claim practice pressure that keeps portable technique canon below stronger
source owners.
...
1. Keep boundary-bridge references pointed at existing technique bundle homes
   when the bundle already exists.
2. Add a new part only if repeated technique-layer bridge signals no longer fit
   owner-boundary anchors, derived-projection anchors, or proof-claim anchors.
3. Promote a reusable boundary-bridge practice into `techniques/` only after it
...
- owner acceptance from this package.
- identity between bridged surfaces.
- Tree-of-Sophia canon or source interpretation.
...
- automatic technique promotion from boundary-shaped pressure.
