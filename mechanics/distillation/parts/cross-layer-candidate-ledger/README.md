...
|---|---|---|---|---|---|
| `skill-marketplace-curation` | `n-skills` | `docs` | landed as [AOA-T-0041](../../../../techniques/instruction/skill-discovery/skill-marketplace-curation/TECHNIQUE.md) | keep it editorial and discovery-focused rather than registry or governance heavy | keep the external intake surface as the canonical donor trail and use [AOA-T-0041](../../../../techniques/instruction/skill-discovery/skill-marketplace-curation/TECHNIQUE.md) for the landed contract |
...
- Wave B landed [AOA-T-0040](../../../../techniques/instruction/capability-boundary/skill-vs-command-boundary/TECHNIQUE.md),
  ...
  and [AOA-T-0043](../../../../techniques/instruction/capability-boundary/multi-source-primary-input-provenance/TECHNIQUE.md),
  with [AOA-T-0041](../../../../techniques/instruction/skill-discovery/skill-marketplace-curation/TECHNIQUE.md)
