...
| `data` | `18` |
| `docs` | `37` |
| `graph-adjacent-artifacts` | `6` |
| `history` | `26` |
| `human-approval-surfaces` | `33` |
| `instructions` | `18` |
| `media` | `6` |
| `memory-adjacent-artifacts` | `14` |
| `runtime-state` | `12` |
| `shell` | `6` |
| `tests` | `19` |
| `tool-surfaces` | `63` |
...
| [AOA-T-0028](../../../../../techniques/execution/agent-workflows-core/confirmation-gated-mutating-action/TECHNIQUE.md) | `agent-workflows` | `guardrail` | `agent-workflows-core` | `choose`, `read`, `plan` | `conversation`, `tool-surfaces`, `shell`, `human-approval-surfaces` | `small-agent` | `read-only`, `approval-required` |
...
| [AOA-T-0055](../../../../../techniques/execution/ready-work-graphs/requirements-design-tasks-ladder/TECHNIQUE.md) | `agent-workflows` | `workflow` | `ready-work-graphs` | `plan`, `read`, `write` | `conversation`, `tool-surfaces`, `code`, `graph-adjacent-artifacts` | `medium-agent` | `read-only` |
...
| [AOA-T-0065](../../../../../techniques/tool-use/tool-gateway/mcp-gateway-proxy/TECHNIQUE.md) | `agent-workflows` | `composition` | `tool-gateway` | `coordinate`, `transform`, `observe` | `conversation`, `tool-surfaces`, `config`, `data` | `orchestration-required` | `public-share`, `approval-required`, `external-evidence` |
...
| [AOA-T-0088](../../../../../techniques/governance/automation-readiness/approval-sensitivity-check/TECHNIQUE.md) | `agent-workflows` | `assessment` | `automation-governance` | `compare`, `choose`, `read` | `conversation`, `tool-surfaces`, `human-approval-surfaces` | `orchestration-required` | `mutating`, `approval-required`, `degraded-mode` |
...
| [AOA-T-0096](../../../../../techniques/proof/owner-truth-closeout/pinned-validation-matrix-before-generated-publish/TECHNIQUE.md) | `agent-workflows` | `validation` | `owner-truth-closeout` | `validate`, `observe`, `read` | `conversation`, `tool-surfaces`, `tests` | `orchestration-required` | `mutating`, `public-share` |
| [AOA-T-0101](../../../../../techniques/governance/practice-adoption-lifecycle/local-pattern-adoption-gate/TECHNIQUE.md) | `agent-workflows` | `guardrail` | `automation-governance` | `choose`, `recover`, `communicate` | `conversation`, `tool-surfaces`, `data`, `human-approval-surfaces` | `orchestration-required` | `public-share`, `approval-required`, `degraded-mode` |
...
| [AOA-T-0058](../../../../../techniques/continuity/handoff-continuation/receipt-confirmed-handoff-packet/TECHNIQUE.md) | `agent-workflows` | `handoff` | `handoff-continuation` | `handoff` | `conversation`, `tool-surfaces`, `human-approval-surfaces` | `small-agent` | `read-only` |
...
| [AOA-T-0011](../../../../../techniques/proof/published-summary/required-vs-optional-source-rendering/TECHNIQUE.md) | `evaluation` | `guardrail` | `published-summary` | `choose`, `observe`, `read` | `tests` | `orchestration-required` | `mutating`, `public-share`, `degraded-mode` |
...
| [AOA-T-0099](../../../../../techniques/recovery/antifragility-recovery/isolated-service-stop-on-shared-substrate/TECHNIQUE.md) | `system-recovery` | `recovery` | `antifragility-recovery` | `recover`, `mutate`, `communicate` | `runtime-state`, `api` | `orchestration-required` | `mutating`, `public-share`, `degraded-mode` |
...
| [AOA-T-0053](../../../../../techniques/history/history-artifacts/local-first-session-index/TECHNIQUE.md) | `history` | `artifact` | `history-artifacts` | `write`, `read`, `interpret` | `history`, `docs`, `data`, `memory-adjacent-artifacts` | `small-agent` | `read-only` |
