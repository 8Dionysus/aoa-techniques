# Technique Kind Counts

This report is a kind-overlay sanity check over the current published catalog mapping.
...
- if any family feels too coarse during landing, adjust the family scout first instead of widening `kind`.
