...
The next move is the tenth pilot migration for `skill-discovery`: move exactly
`AOA-T-0041` and `AOA-T-0042` into
`techniques/instruction/skill-discovery/` without changing frontmatter.
