...
| `agon-candidate-handoff` | Maps Agon requested-only practice candidates into Distillation lanes while preserving Agon source authority and technique-side stop-lines. | [README](parts/agon-candidate-handoff/README.md), [seed registry](parts/agon-candidate-handoff/config/agon_candidate_handoff.seed.json), [generated index](parts/agon-candidate-handoff/generated/agon_candidate_handoff.min.json) | [PROVENANCE](PROVENANCE.md) |
