...
| `technique-reform-ingress` | Collects current topology evidence into a bounded entry packet before future classification reform. | [README](parts/technique-reform-ingress/README.md), [decision](../../docs/decisions/2026-05-03-technique-reform-ingress-packet.md) | [PROVENANCE](PROVENANCE.md) |
