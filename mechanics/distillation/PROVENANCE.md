...
| Technique atom/topology contracts, kind registry, family seed/scout, kind ambiguity audit, and Agon first-narrowing frontier evidence | [parts/technique-reform-ingress](parts/technique-reform-ingress/README.md) | Future classification reform should start from a bounded ingress packet that keeps `domain` and `kind` authoritative, keeps other axes scout/design-only until promoted intentionally, and prevents generated evidence from remapping bundle meaning automatically. |
