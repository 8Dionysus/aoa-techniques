...
| Current evidence-only packet roots under [incoming](../../incoming/README.md), including chat wave packets and personal-media-ingest | `incoming/` packet README/docs/support surfaces plus landed `techniques/**/TECHNIQUE.md` bundles and packet-local closeout memos | First-pass landing queues are exhausted; packet roots preserve donor-wave accounting, explicit exclusions, and closed non-import verdicts while duplicate seed bundles for already landed techniques stay removed. |
