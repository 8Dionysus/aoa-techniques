...
It keeps the donor verdicts reviewable in the Distillation legacy archive while
avoiding collisions with the already-landed lifecycle and readiness families in
the live corpus. It is not an active landing lane.
