...
family formerly staged under `incoming/`.
...
It keeps donor intake, landed-bundle provenance, closed verdicts, and Codex
handoff instructions explicit and separate.
...
This archive follows that posture instead of pretending closed packet evidence
is current canon.
...
- `docs/EXTERNAL_TECHNIQUE_CANDIDATES_PERSONAL_MEDIA_INGEST.md`
  - archived intake and decision surface for the personal-ingest donor family
