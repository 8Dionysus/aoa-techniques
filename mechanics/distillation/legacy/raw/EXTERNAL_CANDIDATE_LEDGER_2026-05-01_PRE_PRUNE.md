...
- the main agent owns wave boundaries, final wording, the cross-doc sequence, shared generated-surface sync, and the release lane so the shared contract does not fragment across workers
