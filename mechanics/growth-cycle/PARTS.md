...
This file maps current Growth-cycle behavior to active `aoa-techniques` parts.
It is not the AoA center stage map and not a raw source inventory.

| Part | Current role | Active source | Provenance |
|---|---|---|---|
| `mastery-harvest` | Names harvest posture, nomination sources, and transfer-scope caution without creating achievement authority. | [parts/mastery-harvest](parts/mastery-harvest/README.md) | [PROVENANCE](PROVENANCE.md) |
