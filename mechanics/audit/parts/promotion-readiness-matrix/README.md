...
- current promoted corpus: `42` techniques
- matrix categorization status: `42` promoted techniques are explicitly categorized in the pack matrix below; Wave 0 matrix expansion is closed for `AOA-T-0075` through `AOA-T-0107`
