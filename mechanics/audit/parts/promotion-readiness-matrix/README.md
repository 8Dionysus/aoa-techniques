...
- current promoted corpus: `45` techniques
- matrix categorization status: `45` promoted techniques are explicitly categorized in the pack matrix below; Wave 0 matrix expansion is closed for `AOA-T-0075` through `AOA-T-0107`
