...
1. residual second-consumer leaders:
   - [AOA-T-0032](../../../../techniques/proof/evaluation-chain/context-report-for-ci/TECHNIQUE.md) remains `promoted`; the 2026-05-12 Stage 1 long-pass sweep logged context-compiler, context-drift, fragment-assembly, dependency-graph, and repo-quality report lanes as adjacent, so reopen only from a CI-facing report over composition coverage or token drift
   - [AOA-T-0035](../../../../techniques/instruction/instruction-surface/profile-preset-composition/TECHNIQUE.md) remains `promoted`; reopen only from a second consumer that uses reviewable module -> profile -> preset layering with preset-first resolution and inspection before startup
   - [AOA-T-0042](../../../../techniques/instruction/skill-discovery/upstream-skill-health-checking/TECHNIQUE.md) remains `promoted`; reopen only from pre-surface source availability plus manifest-readiness evidence, not install/update, security scanning, registry governance, or generic monitoring overlap
   - [AOA-T-0058](../../../../techniques/continuity/handoff-continuation/receipt-confirmed-handoff-packet/TECHNIQUE.md) remains `promoted`; reopen only from receiver-side acceptance of a specific handoff packet before continuation
   - [AOA-T-0059](../../../../techniques/continuity/handoff-continuation/git-verified-handoff-claims/TECHNIQUE.md) remains `promoted`; reopen only from receiver-side verified, mismatched, or unverifiable handoff claims against git evidence before continuation
2. markdown-first and KAG source-lift residuals:
   ...
   - [AOA-T-0046](../../../../techniques/knowledge-lift/kag-source-lift/repo-doc-surface-lift/TECHNIQUE.md) remains `promoted`; `nuxt-content/nuxt-llms` is first second-context support, but the next trigger is a second repo-owned docs route manifest outside framework-specific `llms.txt` generation
...
- `AOA-T-0020`, `AOA-T-0046`, `AOA-T-0047`, and `AOA-T-0048` need stronger corpus or review-reader evidence rather than another generic docs or AI-review lane
