...
| Flat `PROMOTION_WAVE_A_RUNBOOK.md` | [parts/promotion-evidence-runbook](../parts/promotion-evidence-runbook/README.md) | Evidence-prep wave mechanics stay bounded to leading promoted candidates without status flips. | active-moved |
