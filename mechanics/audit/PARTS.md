...
| `promotion-wave-a-runbook` | Describes the current bounded evidence-prep wave for leading promoted candidates. | [README](parts/promotion-wave-a-runbook/README.md) | [PROVENANCE](PROVENANCE.md) |
