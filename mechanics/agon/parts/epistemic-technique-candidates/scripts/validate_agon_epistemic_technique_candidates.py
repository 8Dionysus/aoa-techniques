...
ITEM_SCHEMA = PART_ROOT / "schemas" / "agon-epistemic-technique-candidate.schema.json"
REGISTRY_SCHEMA = PART_ROOT / "schemas" / "agon-epistemic-technique-candidate-registry.schema.json"
