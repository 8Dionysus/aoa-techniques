...
This package owns the `aoa-techniques` side of the cross-project Experience
...
- [Provenance](PROVENANCE.md): active-first bridge back to pre-split Experience
  seed surfaces.
...
- [Governance Precedent](parts/governance-precedent/README.md)
- [Handoff Compression](parts/handoff-compression/README.md)
