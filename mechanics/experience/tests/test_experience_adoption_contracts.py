...
ENUM_ESCAPE_VALUE = "__experience_adoption_not_allowed__"
...
class ExperienceAdoptionContractTests(unittest.TestCase):
    ...
    def test_experience_adoption_schemas_reject_guardrail_boolean_inversions(self) -> None:
        ...
        self.assertGreater(exercised, 0, "no adoption guardrail booleans were exercised")
    ...
    def test_experience_adoption_schemas_reject_non_string_array_items(self) -> None:
        ...
        self.assertGreater(exercised, 0, "no adoption array fields were exercised")
    ...
    def test_experience_adoption_schemas_reject_enum_escape_values(self) -> None:
        ...
        self.assertGreater(exercised, 0, "no adoption enum fields were exercised")
    ...
    def test_experience_adoption_schemas_reject_const_escape_values(self) -> None:
        ...
        self.assertGreater(exercised, 0, "no adoption const fields were exercised")
