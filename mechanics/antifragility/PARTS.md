...
This file maps current antifragility behavior to active `aoa-techniques` parts.
It is not the AoA center antifragility part map and not a raw source inventory.
...
Leave this package as the mechanics layer that explains how antifragility
pressure moved.
