...
antifragility package. It is not a live health surface and not a substitute for
technique review, owner-local receipts, repair proof, or cleanup acceptance.
...
- Added topology coverage for the active antifragility split.
