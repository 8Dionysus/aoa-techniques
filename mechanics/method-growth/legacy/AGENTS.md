...
This card applies to `mechanics/method-growth/legacy/` and every descendant unless a nearer
...
3. `mechanics/method-growth/AGENTS.md`
4. `mechanics/method-growth/PROVENANCE.md`
...
Inherit [../../AGENTS.md](../../AGENTS.md#validation): `mechanics/part-local`; see [VALIDATION.md](../../../VALIDATION.md) and `config/validation_lanes.json`. Local `mechanics/method-growth/legacy/AGENTS.md`: lineage/raw-source boundaries.
## Closeout

Local delta `mechanics/method-growth/legacy/AGENTS.md`: preserve lineage and state any active-source handoff left unchanged.
