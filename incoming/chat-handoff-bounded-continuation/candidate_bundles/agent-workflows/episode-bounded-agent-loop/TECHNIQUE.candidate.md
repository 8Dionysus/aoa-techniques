...
status: draft-seed
origin: chat-handoff-bounded-continuation
note: candidate bundle staged for operator-guided chat wave 3 landing
owners:
  - 8Dionysus
tags:
  - reusable
...
evidence:
  - kind: external_origin
    path: notes/external-origin.candidate.md
---
...
See `examples/episode_checkpoint.candidate.md`.

## Checks

See `checks/checklist.candidate.md`.
