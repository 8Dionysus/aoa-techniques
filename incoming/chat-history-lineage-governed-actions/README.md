...
It keeps the first-pass verdicts reviewable under `incoming/` while respecting
the already-landed history artifact family and existing confirmation-boundary
techniques. It is not an active landing lane.
