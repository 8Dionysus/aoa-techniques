...
- I need to understand status, review posture, or canonical promotion:
  ...
  - [Donor Refinery Rubric](../mechanics/distillation/DONOR_REFINERY_RUBRIC.md)
  - [External Import Runbook](../mechanics/distillation/EXTERNAL_IMPORT_RUNBOOK.md)
  - [Long-Gap Canon Design](../mechanics/distillation/LONG_GAP_CANON_DESIGN.md)
  - [Roadmap](../ROADMAP.md)
  - [External Technique Candidates](../mechanics/distillation/EXTERNAL_TECHNIQUE_CANDIDATES.md)
  - [Cross-Layer Technique Candidates](../mechanics/distillation/CROSS_LAYER_TECHNIQUE_CANDIDATES.md)
...
1. [Start Here](START_HERE.md)
2. [Promotion Readiness Matrix](../mechanics/audit/PROMOTION_READINESS_MATRIX.md)
3. [Promotion Wave A Runbook](../mechanics/audit/PROMOTION_WAVE_A_RUNBOOK.md)
4. [External Evidence Sprint Runbook](../mechanics/audit/EXTERNAL_EVIDENCE_SPRINT_RUNBOOK.md)
5. [External Evidence Ledger](../mechanics/audit/EXTERNAL_EVIDENCE_LEDGER.md)
