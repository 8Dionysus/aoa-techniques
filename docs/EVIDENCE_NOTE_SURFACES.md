...
| `second_context` | Second Context Adaptation | `typed_sections` | `7` fixed sections: `Technique`, `Target project`, `What changed`, `What stayed invariant`, `Risks introduced by adaptation`, `Evidence`, `Result` | `22` |
| `canonical_readiness` | Canonical Readiness | `typed_sections` | `7` fixed sections: `Technique`, `Verdict`, `Evidence summary`, `Default-use rationale`, `Fresh public-safety check`, `Remaining gaps`, `Recommendation` | `22` |
