...
The first whole-tree migration pass is closed for the current corpus.
...
shelves backed by root legacy receipts, and no remaining `split-review-needed`,
...
The twenty-seventh pilot migration moves exactly those three bundles into
...
frontmatter. The root receipt is
[`legacy/receipts/2026-05-05-practice-adoption-lifecycle-tree-pilot.md`](../legacy/receipts/2026-05-05-practice-adoption-lifecycle-tree-pilot.md).
...
The whole-tree closeout review is
[Whole-Tree Closeout Review](../mechanics/distillation/parts/technique-reform-ingress/reviews/whole-tree-closeout-review.md).
It validates that every current bundle path now matches the tree projection,
