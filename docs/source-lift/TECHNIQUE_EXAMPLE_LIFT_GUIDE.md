...
- [Technique Examples](../readers/source-lift/TECHNIQUE_EXAMPLES.md)
...
- reader companion: `docs/readers/source-lift/TECHNIQUE_EXAMPLES.md`
...
`docs/readers/source-lift/TECHNIQUE_EXAMPLES.md` stays domain-first and technique-first.
