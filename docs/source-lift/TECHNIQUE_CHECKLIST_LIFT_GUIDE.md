...
- [Technique Checklists](../readers/source-lift/TECHNIQUE_CHECKLISTS.md)
...
- reader companion: `docs/readers/source-lift/TECHNIQUE_CHECKLISTS.md`
...
`docs/readers/source-lift/TECHNIQUE_CHECKLISTS.md` stays domain-first and technique-first.
