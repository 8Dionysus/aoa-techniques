...
- [Technique Sections](../readers/source-lift/TECHNIQUE_SECTIONS.md)
...
- reader companion: `docs/readers/source-lift/TECHNIQUE_SECTIONS.md`
...
`docs/readers/source-lift/TECHNIQUE_SECTIONS.md` stays heading-first, not technique-first.
