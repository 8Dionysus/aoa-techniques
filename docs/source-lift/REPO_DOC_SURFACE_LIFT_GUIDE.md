...
authoritative public route, canon-law, contribution, and status layer
...
- authoritative source: the current bounded set of authored public route,
  canon-law, contribution, and status files
- reader companion: `docs/readers/repo/REPO_DOC_SURFACES.md`
