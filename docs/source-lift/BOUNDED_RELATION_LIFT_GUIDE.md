...
- [Selection Patterns](../readers/selection/SELECTION_PATTERNS.md)
...
The current job is to keep the bounded direct-edge layer explicit both as a repo rule and as the reusable technique captured in [`bounded-relation-lift-for-kag`](../../techniques/knowledge-lift/kag-source-lift/bounded-relation-lift-for-kag/TECHNIQUE.md), without reopening whether relations are already a graph platform.
