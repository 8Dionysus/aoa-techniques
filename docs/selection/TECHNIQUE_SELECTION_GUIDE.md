...
- adjacent but separate family:
  - `docs/readers/review/SHADOW_PATTERNS.md` stays under `docs/review/TECHNIQUE_SHADOW_GUIDE.md`, even though it is generated by the same build step
- derived manifests:
...
`docs/readers/review/SHADOW_PATTERNS.md` remains adjacent, but separate. It is a canonical-only caution lookup surface and should not be read as part of the selection-family contract.
