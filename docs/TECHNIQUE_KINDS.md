...
| `handoff` | Checkpoint, packet, mailbox, receipt, continuation, or resume seam across runs, agents, approvals, or episodes. | `11` | `3` | `8` |
...
Counts: `total` 11, `canonical` 3, `promoted` 8.
