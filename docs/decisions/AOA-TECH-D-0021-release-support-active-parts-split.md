...
- Decision ID: AOA-TECH-D-0021
- Original date: 2026-05-02
- Surface classes: mechanic package, mechanic part, release/GitHub
- Technique axes: mechanic bridge, github landing
- Mechanic parents: release-support
- Guard families: mechanic topology, part-local artifact, release/tooling
- Posture: accepted
