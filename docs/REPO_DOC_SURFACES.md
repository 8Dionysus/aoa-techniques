...
| doc | bounded role | top-level sections |
|---|---|---|
| [AGENTS.md](../AGENTS.md) (`AGENTS.md`) | contributor doctrine for public-safe planning, focused diffs, verification, and reporting | `Purpose`, `Owner lane`, `Start here`, `Route modes`, `AGENTS stack law`, `GitHub landing workflow`, `Post-change route review`, `Route away when`, `Verify`, `Report`, `Full reference` |
