...
| [Technique Tree Contract](TECHNIQUE_TREE_CONTRACT.md) (`docs/TECHNIQUE_TREE_CONTRACT.md`) | corpus tree contract for scalable technique path architecture across trunks, shelves, and leaf bundles | `Purpose`, `Tree Law`, `Tree Stack`, `Trunk Draft`, `Tree Versus Facets`, `Migration Rules`, `Leaf Bundle Rules`, `Generated Projection Path`, `Stop Lines`, `Next Honest Build Path` |
