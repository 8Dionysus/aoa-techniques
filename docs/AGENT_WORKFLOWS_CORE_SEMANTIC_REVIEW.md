...
|---|---|
| [AOA-T-0001](../techniques/execution/agent-workflows-core/plan-diff-apply-verify-report/TECHNIQUE.md) | canonical workflow backbone for bounded repository changes |
| [AOA-T-0004](../techniques/execution/intent-chain/intent-plan-dry-run-contract-chain/TECHNIQUE.md) | intent-chain specialization for artifact-first normalization and dry-run checking |
| [AOA-T-0014](../techniques/execution/agent-workflows-core/tdd-slice/TECHNIQUE.md) | bounded execution and test slice discipline inside one implementation change |
...
- Invariant boundary: [AOA-T-0001](../techniques/execution/agent-workflows-core/plan-diff-apply-verify-report/TECHNIQUE.md) owns the generic execution contract of plan, bounded diff, verification, and explicit reporting for repository work. [AOA-T-0004](../techniques/execution/intent-chain/intent-plan-dry-run-contract-chain/TECHNIQUE.md) begins when the main problem is not generic execution hygiene, but stabilizing an intent-shaped artifact chain before real execution exists.
...
- Invariant boundary: [AOA-T-0001](../techniques/execution/agent-workflows-core/plan-diff-apply-verify-report/TECHNIQUE.md) owns the overall work loop. [AOA-T-0014](../techniques/execution/agent-workflows-core/tdd-slice/TECHNIQUE.md) begins when the main risk is a single behavior slice widening during implementation and the safer move is to keep execution and verification pinned to one bounded slice.
...
- Invariant boundary: [AOA-T-0004](../techniques/execution/intent-chain/intent-plan-dry-run-contract-chain/TECHNIQUE.md) owns artifact-first intent normalization and dry-run contract checking before the live path is trusted. [AOA-T-0014](../techniques/execution/agent-workflows-core/tdd-slice/TECHNIQUE.md) owns the execution discipline for one bounded implementation slice after the target path is already clear enough to work on directly.
