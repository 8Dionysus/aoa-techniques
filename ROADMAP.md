...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `ready-work-graphs` pilots as precedents, and run the
  `execution/intent-chain` direct-read review before any other shelf movement
