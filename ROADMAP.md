...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `evaluation-chain` direct-read migration review before any broader corpus
  move.
