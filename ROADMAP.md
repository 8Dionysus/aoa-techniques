...
| Next honest move | Migrate exactly `AOA-T-0101`, `AOA-T-0103`, and `AOA-T-0104` into `techniques/governance/practice-adoption-lifecycle/`. |
...
Current latest direct-read review: the `practice-adoption-lifecycle`
direct-read review accepts exactly `AOA-T-0101`, `AOA-T-0103`, and
`AOA-T-0104` as the twenty-seventh migration pilot and does not move files or
change frontmatter.
