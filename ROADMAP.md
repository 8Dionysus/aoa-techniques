...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `ready-work-graphs`, and `intent-chain` pilots as precedents, and migrate
  exactly `AOA-T-0001`, `AOA-T-0014`, `AOA-T-0023`, `AOA-T-0028`, and
  `AOA-T-0031` into `techniques/execution/agent-workflows-core/` before any
  other shelf movement or broader corpus move.
