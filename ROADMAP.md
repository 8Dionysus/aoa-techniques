...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  review the landed `history-artifacts` pilot before any other shelf movement
  or broader corpus move.
