...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `skill-discovery`, `skill-support`, and `evaluation-chain` pilots as
  precedents, and run the thirteenth `published-summary` pilot migration before
  any other shelf movement or broader corpus move.
