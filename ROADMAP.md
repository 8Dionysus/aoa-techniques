...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  run the `recovery/antifragility-recovery` direct-read migration review before
  any fifteenth shelf movement or broader corpus move.
