...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  precedents, and run the `published-summary` direct-read review before any
  thirteenth shelf migration or broader corpus move.
