...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `ready-work-graphs`, and `intent-chain` pilots as precedents, and run the
  `execution/agent-workflows-core` direct-read review before any other shelf
  movement or broader corpus move.
