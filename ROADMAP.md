...
| Next honest move | Review the landed `governance/practice-adoption-lifecycle` pilot before routing the `tool-use/tool-gateway` singleton or another discovered tail. |
...
exactly `AOA-T-0101`, `AOA-T-0103`, and `AOA-T-0104` into
`techniques/governance/practice-adoption-lifecycle/` without changing
