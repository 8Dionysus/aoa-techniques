...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  pilots as precedents, and run the accepted `execution/ready-work-graphs`
  migration before any other shelf movement or broader corpus move.
