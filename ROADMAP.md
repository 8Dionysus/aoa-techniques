...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `ready-work-graphs` pilots as precedents, and migrate exactly `AOA-T-0004`
  and `AOA-T-0005` into `techniques/execution/intent-chain/` before any other
  shelf movement or broader corpus move.
