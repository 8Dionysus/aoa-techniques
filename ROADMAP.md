...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `skill-discovery` pilots as precedents, and run the `skill-support`
  eleventh pilot migration before any broader corpus move.
