...
| Next honest move | Migrate exactly `AOA-T-0086`, `AOA-T-0087`, and `AOA-T-0088` into `techniques/governance/automation-readiness/`. |
...
Current latest tree migration: the `owner-truth-closeout` pilot moved exactly
`AOA-T-0091`, `AOA-T-0092`, `AOA-T-0095`, `AOA-T-0096`, and `AOA-T-0094` into
`techniques/proof/owner-truth-closeout/` without changing frontmatter. It
completes the previous next honest move: Migrate exactly `AOA-T-0091`,
`AOA-T-0092`, `AOA-T-0095`, `AOA-T-0096`, and `AOA-T-0094` into
`techniques/proof/owner-truth-closeout/` after support-file carry, proof
route-card update, receipt, generated rebuild, validation, PR checks, and
merge.
...
Current latest direct-read review: the `automation-readiness` direct-read
review accepts exactly `AOA-T-0086`, `AOA-T-0087`, and `AOA-T-0088` as the
twenty-fifth migration pilot, keeps Candidate B and Candidate C queued, and
