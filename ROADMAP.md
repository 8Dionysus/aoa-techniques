...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `published-summary`, and `history-artifacts` pilots as precedents, and
  move exactly `AOA-T-0097`, `AOA-T-0099`, `AOA-T-0100`, and `AOA-T-0098`
  into `techniques/recovery/antifragility-recovery/` before any broader corpus
  move.
