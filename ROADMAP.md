...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  precedents, and review the landed `evaluation-chain` pilot before any
  broader corpus move.
