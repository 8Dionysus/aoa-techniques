...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `skill-discovery`, `skill-support`, `evaluation-chain`, and
  `published-summary` pilots as precedents, and run the fourteenth
  `history-artifacts` pilot migration before any other shelf movement or
  broader corpus move.
