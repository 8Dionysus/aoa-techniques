...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `skill-discovery` pilots as precedents, and run a direct-read migration
  review for `skill-support` before any broader corpus move.
