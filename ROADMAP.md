...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  precedents, and review the landed `agent-workflows-core` shelf before any
