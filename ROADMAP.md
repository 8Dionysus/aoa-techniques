...
| Next honest move | Run the `governance/practice-adoption-lifecycle` direct-read review before any twenty-seventh shelf movement. |
...
Current latest landed split review: the landed `promotion-boundary` pilot
review validates the second split shelf and chooses
