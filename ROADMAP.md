...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  pilots as precedents, and run the `execution/ready-work-graphs` direct-read
  migration review before any other shelf movement or broader corpus move.
