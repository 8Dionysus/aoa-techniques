...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `ready-work-graphs`, and `intent-chain` pilots as precedents, and review the
  landed `intent-chain` pilot before any other shelf movement or broader corpus
  move.
