...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  precedents, and review the landed `capability-boundary` pilot before any
  broader corpus move.
