...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `published-summary`, `history-artifacts`, `antifragility-recovery`, and
  `ready-work-graphs` pilots as precedents, and review the landed
  `ready-work-graphs` pilot before any other shelf movement or broader corpus
  move.
