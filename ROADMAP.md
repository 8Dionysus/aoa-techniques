...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `skill-discovery`, and `skill-support` pilots as precedents, and run the
  `evaluation-chain` twelfth pilot migration before any broader corpus move.
