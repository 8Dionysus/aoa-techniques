...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  precedents, and run the `continuity/donor-harvest` direct-read review before
