...
Current latest tree review: the `owner-truth-closeout` direct-read review
accepts exactly `AOA-T-0091`, `AOA-T-0092`, `AOA-T-0095`, `AOA-T-0096`, and
`AOA-T-0094` for the twenty-fourth pilot without moving files or changing
frontmatter. It completes the previous next honest move: Run the `proof/owner-truth-closeout` direct-read migration review before any twenty-fourth shelf movement.
