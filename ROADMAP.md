...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `published-summary`, `history-artifacts`, and `antifragility-recovery`
  pilots as precedents, and review the landed `antifragility-recovery` pilot
  before any other shelf movement or broader corpus move.
