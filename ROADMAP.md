...
| Next honest move | Migrate exactly `AOA-T-0089`, `AOA-T-0090`, and `AOA-T-0102` into `techniques/governance/promotion-boundary/`. |
...
Current latest tree migration: the `automation-readiness` pilot moved exactly
`AOA-T-0086`, `AOA-T-0087`, and `AOA-T-0088` into
`techniques/governance/automation-readiness/` without changing frontmatter. It
completes the previous next honest move: Migrate exactly `AOA-T-0086`,
`AOA-T-0087`, and `AOA-T-0088` into
