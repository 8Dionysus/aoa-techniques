...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `skill-discovery`, and `skill-support` pilots as precedents, and review the
  landed `skill-support` pilot before any broader corpus move.
