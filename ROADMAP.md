...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `published-summary` pilots as precedents, and review the landed
  `published-summary` pilot before any other shelf movement or broader corpus
  move.
