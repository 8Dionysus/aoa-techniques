...
- Use the landed `review-compaction`, `handoff-continuation`, `media-ingest`,
  ...
  `published-summary` pilots as precedents, and run the `history-artifacts`
  direct-read migration review before any other shelf movement or broader
  corpus move.
