...
from validate_repo import (
    build_section_reader_markdown,
    build_section_manifest_payloads,
    collect_techniques,
    load_schema_store,
    write_json_file,
    write_text_file,
...
def main() -> int:
    ...
    full_manifest, min_manifest = build_section_manifest_payloads(repo_root, records)
    reader_markdown = build_section_reader_markdown(repo_root, records)
