...
from validate_repo import (
    build_example_manifest_payloads,
    build_example_reader_markdown,
    collect_techniques,
    load_schema_store,
    write_json_file,
    write_text_file,
...
def main() -> int:
    ...
    full_manifest, min_manifest = build_example_manifest_payloads(repo_root, records)
    reader_markdown = build_example_reader_markdown(repo_root, records)
    ...
    full_path = generated_dir / "technique_example_manifest.json"
    min_path = generated_dir / "technique_example_manifest.min.json"
    reader_path = reader_dir / "TECHNIQUE_EXAMPLES.md"
