...
- [AOA-T-0059](../techniques/agent-workflows/git-verified-handoff-claims/TECHNIQUE.md) - git-verified-handoff-claims (`agent-workflows`, current `handoff`): current-kind cues `handoff`, `continuation`; opposing `workflow` cues `workflow`. Verdict: `keep current kind`.
