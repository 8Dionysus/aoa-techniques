...
- the pattern can collapse into [AOA-T-0016](../../../../proof/skill-support/bounded-context-map/TECHNIQUE.md) if repositories stop separating conceptual context boundaries from a task-bounded startup map
