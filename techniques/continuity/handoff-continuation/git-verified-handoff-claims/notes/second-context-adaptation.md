...
- the public bundle could drift into [AOA-T-0045](../../../../history/history-artifacts/witness-trace-as-reviewable-artifact/TECHNIQUE.md) if teams expect a full run artifact instead of one bounded trust check
