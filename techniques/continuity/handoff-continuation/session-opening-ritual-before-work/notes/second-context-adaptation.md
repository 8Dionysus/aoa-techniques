...
- the pattern can collapse into [AOA-T-0001](../../../../execution/agent-workflows-core/plan-diff-apply-verify-report/TECHNIQUE.md) if repositories stop separating the session-opening seam from the full change workflow
