...
- the pattern can collapse into [fail-closed-evidence-gate](../../fail-closed-evidence-gate/TECHNIQUE.md) if repositories stop distinguishing one-shot boundary verdicts from longer-running durable continuity
