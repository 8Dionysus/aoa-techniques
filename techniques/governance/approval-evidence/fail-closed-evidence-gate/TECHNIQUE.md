...
- keep [AOA-T-0028](../../../execution/agent-workflows-core/confirmation-gated-mutating-action/TECHNIQUE.md) as the human-confirmation sibling rather than widening this bundle into human approval doctrine
