...
- `docs/source-lift/FRONTMATTER_METADATA_SPINE_GUIDE.md` explicitly frames this behavior as a metadata spine and keeps section meaning outside frontmatter
