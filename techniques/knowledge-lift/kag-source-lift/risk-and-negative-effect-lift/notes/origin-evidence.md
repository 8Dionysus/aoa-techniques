...
## Evidence
- `docs/review/TECHNIQUE_SHADOW_GUIDE.md` already defines the five-part shadow-language split as the current markdown-first caution contract
- `docs/source-lift/RISK_AND_NEGATIVE_EFFECT_LIFT_GUIDE.md` already describes bounded caution lift as a later reusable source-lift surface without metadata or scoring
