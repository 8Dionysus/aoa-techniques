...
## Evidence
- `docs/source-lift/REPO_DOC_SURFACE_LIFT_GUIDE.md` explicitly frames a bounded public docs/status source class and excludes local planning docs, deeper guides, and review docs
- `generated/repo_doc_surface_manifest.json` shows the current public repo-doc set as a bounded derived routing surface
- `docs/readers/repo/REPO_DOC_SURFACES.md` exposes the same bounded routing contract to readers without replacing the authored docs
