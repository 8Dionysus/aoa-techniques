...
- `docs/source-lift/KAG_SOURCE_LIFT_GUIDE.md` explicitly frames GitHub review templates as a bounded source-class pilot and keeps policy or state behavior deferred
