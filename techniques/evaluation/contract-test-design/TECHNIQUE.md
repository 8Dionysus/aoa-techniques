...
See `checks/contract-test-design-checklist.md` for a minimal review pass covering real boundary visibility, downstream assumptions, and explicit contract guarantees.
