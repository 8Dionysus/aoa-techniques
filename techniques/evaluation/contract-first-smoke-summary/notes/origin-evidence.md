...
## Interpretation
- The origin proves this technique as a reusable producer-layer contract over multiple smoke families: summaries are standardized, discoverable, and treated as the primary acceptance surface for downstream CI, operators, and agents.
