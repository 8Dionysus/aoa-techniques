...
A later revision should include one public mini-map showing how two neighboring contexts are separated and how their handoff is described.

## Checks

A minimal review pass should confirm that the map actually reduces confusion instead of just adding labels.
