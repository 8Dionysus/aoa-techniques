...
class ExperienceGovernanceContractTests(unittest.TestCase):
    ...
    def test_experience_governance_schemas_reject_unknown_fields(self) -> None:
        ...
        self.assertGreater(exercised, 0, "no governance object fields were exercised")
    ...
    def test_experience_governance_schemas_reject_wrong_types_for_every_field(self) -> None:
        ...
        self.assertGreater(exercised, 0, "no governance fields were exercised")
    ...
    def test_experience_governance_schemas_reject_missing_required_fields(self) -> None:
        ...
        self.assertGreater(exercised, 0, "no governance required fields were exercised")
    ...
    def test_experience_governance_schemas_reject_bad_array_items(self) -> None:
        ...
        self.assertGreater(exercised, 0, "no governance array fields were exercised")
    ...
    def test_experience_governance_schemas_reject_const_escapes(self) -> None:
        ...
        self.assertGreater(exercised, 0, "no governance const fields were exercised")
