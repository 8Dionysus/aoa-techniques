...
This file preserves the previous full root guidance for `aoa-techniques`.
...
7. `WALKTHROUGH.md`
8. `docs/readers/selection/TECHNIQUE_SELECTION.md`
...
- feat-reader or capsule surfaces:
  ...
  `docs/readers/runtime/TECHNIQUE_CAPSULES.md`, and
...
- source-lift, KAG export, or section families:
  ...
  `docs/readers/source-lift/TECHNIQUE_SECTIONS.md`, and the matching
  section-lift guides
